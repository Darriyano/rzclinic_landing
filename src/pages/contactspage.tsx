    ...
    return (<>
        ...
        <div className="bg-img">
            <div className="contacts-intro-screen">
                ...
                <div className="secondary">Задайте вопрос или запишитесь на прием по телефону, через социальные
                    сети (WhatsApp/Telegram) или по почте
                </div>
            </div>
                ...
                <div className="contacts-text-block">
                    <ul>
                        <li className="contacts-list">
                            <div>
                                <img src={Call} alt=""/> Телефон/WhatsApp:
                            </div>
                            <p>+7 (927) 077-19-00</p>
                        </li>
                        <li className="contacts-list">
